 ...
 * WARRANTIES.
 * 
 * RCS: @(#) $Id: TclInterruptedException.java,v 1.1.1.1 1998/10/14 21:09:14 cvsadmin Exp $
 *
 */
 ...
 * Interp.setInterrupted() API. This exception is used
 * to unwind the Tcl stack and remove pending events
 * from the Tcl event queue.
 */

public final
class TclInterruptedException extends RuntimeException {
    Interp interp;
...
class TclInterruptedExceptionEvent extends TclEvent
