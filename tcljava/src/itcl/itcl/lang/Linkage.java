 ...
 *
 *     RCS:  $Id: Linkage.java,v 1.5 2005/02/03 07:16:51 mo Exp $
 * ========================================================================
...
class AssocHashtable extends Hashtable
 ...
 *
 *  Used to associate a symbolic name with a Java procedure
 ...
 *  definition to specify Java procedures to acting as methods/procs.
...
void
RegisterObjC(
    Interp interp,     // interpreter handling this registration
 ...
 *
 *  Used to query a Java procedure via its symbolic name.  Looks at the
 *  list of procedures registered previously by RegisterObjC and
 *  returns the ItclJavafunc record if found; returns null otherwise.
 * ------------------------------------------------------------------------
 */
 ...
 *  free up the associated data created by RegisterObjC.
 * ------------------------------------------------------------------------
 */
